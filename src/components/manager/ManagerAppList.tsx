...
import { ArrowLeft, Plus, Activity, Edit } from 'lucide-react';
...
const ManagerAppList = ({ onBack, user }: ManagerAppListProps) => {
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-xs text-gray-500">
                      ...
                      <div>
                        <span className="font-medium">Active Users:</span> {app.activeUsers}
                      </div>
                    </div>
                  </div>
                </div>
