  ...
  useEffect(() => {
    const loadUser = async () => {
      try {
        ...
        setUser(currentUser);
        console.log('🏠 StaffLayout loaded user:', currentUser);
      } catch (error) {
        console.error('StaffLayout error loading user:', error);
      } finally {
        setIsLoading(false);
      }
    };
        ...
        <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center space-x-4">
              ...
              />
              <div>
                <div className="text-xl font-bold text-gray-800">Access Request</div>
            ...
            <div className="space-y-1">
              <button 
                ...
                className={`w-full px-4 py-3 text-left rounded-lg transition-colors flex items-center space-x-3 ${
                  isActiveRoute('/staff') && location.pathname === '/staff'
              ...
              <button 
                onClick={() => navigate('/staff/myrequest')}
                className={`w-full px-4 py-3 text-left rounded-lg transition-colors flex items-center space-x-3 ${
                  isActiveRoute('/staff/myrequest')
                    ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-500' 
                    : 'text-gray-600 hover:bg-gray-50'
                }`}
              >
              ...
              >
                ...
                <span className="font-medium">App Catalog</span>
              </button>
            </div>
